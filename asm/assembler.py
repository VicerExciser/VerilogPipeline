            ...
            if t[0] in SYS_TYPE:
            	...
            	if t[0] == 'reti':
            		...
            		if t[0] == 'rsr':
	            		...
	            		ss = sys_regs[t[2].lower()]

	            		bin32 = opcode + rd + ss + tail

	            	elif t[0] == 'wsr':

	            		# op2 = '00000011'

	            		sd = sys_regs[t[1].lower()]

	            		rs = regs[t[2].lower()]

	            		bin32 = opcode + sd + rs + tail
...
sys_regs = {
	...
	'pcs'	:	'0000',	# Processor control & status reg

	'iha'	:	'0001', # Interrupt handler address reg

	'ira'	:	'0010', # Interrupt return address reg

	'idn'	:	'0011'  # Interrupt device number reg
}
